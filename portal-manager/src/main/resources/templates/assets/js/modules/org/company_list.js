var Company = {
    ...
    list: {
        ...
        delByIds:function(ids){
            var _this = this;
            $.POST({ url: basePath+'/org/company/dels', data: {ids:ids.join(',')},
                success:function (res) {
                    if(res.code == ReturnCode.SUCCESS){
                        _this.grid.reload();
                        showSucTips("删除成功！");
        ...
        openIpt:function(row, editable){
            ...
            var url = basePath + "/org/company/input";
            // 【弹窗模式】 弹窗添加修改页面
            mini.open({
                url: url,
                allowResize:true,
                ...
                onload: function () {
                    if(row!=undefined) {
                        ...
                        iframe.contentWindow.Company.input.setData(row);
                        if(undefined != editable&&!editable){
                            iframe.contentWindow.Company.view.init();
                        }
                    }
                },
        ...
        uniqueCode:function (e) {
            ...
            if (code == "" || code == null) {
                ...
                $.POST({
                    url: basePath+"/org/company/checkCode",
        ...
        uniqueEname:function (e) {
            ...
            if (ename == "" || ename == null) {
                ...
                $.POST({
                    url: basePath+"/org/company/uniqueEname",
    ...
    input: {
        ...
        save:function(){
            ...
            var url = basePath + (formData.id==""?"/org/company/insert":"/org/company/update");
