...
<div class="mini-panel mini-fit cust-panel"  showFooter="true" footerStyle="padding:5px;" showHeader="false" style="width:100%;height:100%;">
    <form id="jsDicMainForm">
        <input class="mini-hidden" type="hidden" name="id" id="id" />
        <input class="mini-hidden" type="hidden" name="dicTypeId" id="dicTypeId" />
        <table style="width:90%;padding:10px 25px 0px 0px;">
            ...
            <tr>
                ...
                <td><input id="ename" name="ename" errorMode="border" class="mini-textbox form" required="false" requiredErrorText="名称不能为空！" emptyText="请输入名称" style="width:100%;" /></td>
            </tr>
            <tr>
                <td align="right" style="vertical-align:top;padding-top:8px;">备注：</td>
