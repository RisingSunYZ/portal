...
if(_a5=="manual"){
$("<span style=\"padding-left:26px;\"></span>").html(_a1.beforePageText).appendTo(tr).wrap("<td></td>");
...
ps.before("每页");
ps.after($("<div class=\"pagination-info\"></div>")).after("条，");
...
var t=$(_c3);
return $.extend({},{pageList:(t.attr("pageList")?eval(t.attr("pageList")):undefined)},$.parser.parseOptions(_c3,[{total:"number",pageSize:"number",pageNumber:"number",links:"number"},{loading:"boolean",showPageList:"boolean",showRefresh:"boolean"}]));
};
$.fn.pagination.defaults={total:1,pageSize:15,pageNumber:1,pageList:[15,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,links:15,layout:["list","first","prev","next","last","manual","sep"],onSelectPage:function(_c4,_c5){
},onBeforeRefresh:function(_c6,_c7){
},onRefresh:function(_c8,_c9){
},onChangePageSize:function(_ca){
},beforePageText:"第",afterPageText:"页　共 {pages} 页",displayMsg:"共 {total} 条记录",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:32,selected:0,showHeader:true,plain:false,fit:false,border:true,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_367){
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["日","一","二","三","四","五","六"],months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一","十二"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:(function(){
var d=new Date();
...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_8a2,keydown:_8a6,paste:_8a6,drop:_8a6},panelWidth:null,panelHeight:150,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
_972(this,q);
}},currentText:"今天",closeText:"关闭",okText:"确定",buttons:[{text:function(_985){
