...
export default class TableList extends PureComponent {
  ...
  render() {
    ...
    const path = "/news-notice/news-list/"+this.state.activeKey;
      ...
      <Fragment>
          <Row>
            ...
            <Col offset={1} span={14}>
              <Card bordered={false} bodyStyle={{padding:"0px 12px 12px"}} >
                <Tabs defaultActiveKey="a" tabBarExtraContent={<Link to={"/news-notice/notice-table/finance_notice"}> 更多> </Link>}>
          ...
          <Row style={{marginTop: 24}}>
            <Col span={9}>
              <Card bordered={false} bodyStyle={{padding:"0px 12px 12px"}} >
                <Tabs defaultActiveKey="b" tabBarExtraContent={<Link to="/news-notice/news-list/finance_info"> 更多> </Link>} >
            ...
            <Col offset={1} span={14}>
              <Card bordered={false} bodyStyle={{padding:"0px 12px 12px"}} >
                <Tabs onChange={this.expenseAndProChange} tabBarExtraContent={<Link to={path}> 更多> </Link>} >
            ...
            <Card bordered={false} bodyStyle={{padding:"0px 12px 12px"}} >
              <Tabs>
                <Tabs.TabPane tab="资料下载" key="download" >
                  <Tabs onChange={this.tabsChange} tabBarExtraContent={<Link to="/fnc-service/material-filepage"> 更多> </Link>}>
