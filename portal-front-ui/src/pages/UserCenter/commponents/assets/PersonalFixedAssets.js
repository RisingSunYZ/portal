...
export default class PersonalFixedAssets extends Component {
  state = {};
  componentDidMount() {
    const { dispatch } = this.props;
    dispatch({
      type: 'assets/getPersonalFixedAssetsList',
      payload: { cateName: '固定资产',type:'use',userNo:this.props.userNo },
    });
  }
  ...
  render() {
    ...
    return (
      <div>
        <Table columns={columns} dataSource={pfList}
               pagination={{
                 pageSize:5,
