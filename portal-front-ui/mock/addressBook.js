...
const getConcactPersonData = (req, res, url) =>{
...
export default {
  'GET /portal/api/process/ajaxListWfCategory': getAddressBook,
  'POST /portal/api/process/ajaxListWfCategory': getAddressBook,
  'GET /rest/process/list/ajaxListModel': getConcactPersonData,
  'POST /rest/process/list/ajaxListModel': getConcactPersonData,
};
