...
public interface IDicTypeDao {
     ...
     * @Description:
     */
    public List<com.dragon.portal.model.basedata.DicType> getDicTypeByIds(@Param("ids") String ids) throws Exception;
     ...
     * @Description:
     */
    public Page<com.dragon.portal.model.basedata.DicType> getPagerModelByQuery(com.dragon.portal.model.basedata.DicType dicType) throws Exception;
     ...
     * @Description:
     */
    public void delDicTypeByIds(@Param("ids") String ids) throws Exception;
     ...
     * @Description:
     */
    public int updateDicTypeByIds(@Param("ids") String ids, @Param("dicType") com.dragon.portal.model.basedata.DicType dicType) throws Exception;
     ...
     * @Description:
     */
    public int updateDicTypeByIdsList(@Param("ids") List<String> ids, @Param("dicType") com.dragon.portal.model.basedata.DicType dicType) throws Exception;
