...
@Mapper
@Repository
public interface IMeetingroomConftoolsDao {
	...
	/**
	 * 通过会议室Id批量删除会议室配置用具项中间表MeetingroomConftools
	 * @param mettingroomId
	 * @throws Exception
	 * @Description:
	 */
	public void delMeetingroomConftoolsByMettingRoomId(String mettingroomId)throws Exception;
	
	/**
	 * 通过会议室Id得到该会议室配置用具项中间表MeetingroomConftools
	 * @param mettingroomId
	 * @throws Exception
	 * @Description:
	 */
