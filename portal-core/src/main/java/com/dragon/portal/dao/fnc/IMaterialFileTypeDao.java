 ...
 */
public interface IMaterialFileTypeDao {
	 ...
	 * @Description:
	 */
	public Page<MaterialFileType> getPagerModelByQuery(MaterialFileType materialFileType) throws Exception;
