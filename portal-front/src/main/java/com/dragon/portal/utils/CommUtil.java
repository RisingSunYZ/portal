...
public class CommUtil {
	...
	public static String getDateAfterMonth(Date date, int month) {
		if(CommUtil.isNull(date)) return null;
	...
	public static Long getDateAfterHour(Date date,int hour) {
		if(CommUtil.isNull(date)) return 0L;
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
	...
	public static String encodeUrl(String encodeURL, String charsetEncode) {
		String url = "";
		if (CommUtil.isEmpty(encodeURL) || CommUtil.isEmpty(charsetEncode))
			return url;
		try {
	...
	public static String decodeUrl(String decodeURL, String charsetEncode) {
		String url = "";
		if (CommUtil.isEmpty(decodeURL) || CommUtil.isEmpty(charsetEncode))
			return url;
		try {
	...
	*/
	...
	public static String formatStr(String str,String spliter,int splitsize,String newSpliter){
		if(CommUtil.isEmpty(str) || CommUtil.isEmpty(spliter) || splitsize<=0){
			return "";
		}
	 ...
	 * @return
	 */
	public static String decodeString(String value, String enc){
		String res = "";
		try{
			if(org.apache.commons.lang3.StringUtils.isNotBlank(value)){
				res = URLDecoder.decode(value, enc);
			}
		}catch(Exception e){
			e.printStackTrace();
		}
