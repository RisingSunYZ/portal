...
@Controller
@RequestMapping("/portal/process/common")
public class ProcessCommonController extends BaseController {
	private static Logger logger = Logger.getLogger(ProcessCommonController.class);
