...
public class FileOperationController {
	...
	@ApiImplicitParams({
			...
			@ApiImplicitParam(paramType="query", name = "quality", value = "输出图片的质量【1-10】", dataType = "Integer", defaultValue = "1"),
			@ApiImplicitParam(paramType="query", name = "width", value = "输出图片的宽度", dataType = "Integer", defaultValue = "500"),
			@ApiImplicitParam(paramType="query", name = "height", value = "输出图片的高度", dataType = "Integer", defaultValue = "500")
	})
